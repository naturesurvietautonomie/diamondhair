...
const PRODUCTS = [
  ...
  { id: 'dh51', cat: 'accessoires', name: 'Bonnet Satin Anti-casse Nuit', subtitle: 'Protection nocturne — Incontournable', price: 7, description: "Le bonnet en satin est l'accessoire numéro 1 de toute personne aux cheveux naturels. Le satin réduit les frottements nocturnes, préserve l'hydratation et évite la casse.", benefits: ['Réduit les frottements', "Préserve l'hydratation", 'Anti-casse nocturne', 'Maintient le coiffé'], img: 'images/dh51_bonnet_satin.jpg', stripe: 'https://buy.stripe.com/9B68wH3UD3NT1R14jIcfL0u' },
  { id: 'dh52', cat: 'accessoires', name: 'Serviette Microfibre Turban Cheveux', subtitle: 'Séchage doux sans frisottis', price: 6, description: "La serviette microfibre est indispensable pour les cheveux bouclés et naturels. Elle absorbe l'eau sans frotter ni créer de frisottis. Le turban se pose en 5 secondes.", benefits: ['Aucun frisotti', 'Absorption rapide', 'Turban auto-maintenu', 'Pour cheveux bouclés'], img: 'images/dh52_serviette_microfibre.jpg', stripe: 'https://buy.stripe.com/8x27sDdvd849brB6rQcfL0v' },
